 ...
 *
 *  @param[in,out]  buffer                           Pointer to ACI message
 * buffer
 *  @param[in]      p_aci_cmd_params_set_local_data  Pointer to the local data
 * parameters in ::aci_cmd_params_set_local_data_t
 ...
 *
 *  @param[in,out]  buffer                    Pointer to ACI message buffer
 *  @param[in]      p_aci_cmd_params_connect  Pointer to the run parameters in
 ...
 *
 *  @param[in,out]  buffer                 Pointer to ACI message buffer
 *  @param[in]      p_aci_cmd_params_bond  Pointer to the run parameters in
 ...
 *
 *  @param[in,out]  buffer                       Pointer to ACI message buffer
 *  @param[in]      p_aci_cmd_params_disconnect  Pointer to the run parameters
 * in ::aci_cmd_params_disconnect_t
 *
 *  @return         None
 */
 ...
 *
 *  @param[in,out]  buffer                         Pointer to ACI message buffer
 *  @param[in]      p_aci_cmd_params_set_tx_power  Pointer to the set Tx power
 * parameters in ::aci_cmd_params_set_tx_power_t
 *
 *  @return         None
 */
 ...
 *
 *  @param[in,out]  buffer                        Pointer to ACI message buffer
 *  @param[in]      p_aci_cmd_params_send_data_t  Pointer to the data parameters
 * in ::aci_cmd_params_send_data_t
 *  @param[in]      data_size                     Size of data message
 *
 *  @return         None
 */
 ...
 *  @param[in,out]  buffer                          Pointer to ACI message
 * buffer
 *  @param[in]      p_aci_cmd_params_request_data   Pointer to the request data
 * parameters in ::aci_cmd_params_request_data_t
 *
 *  @return         None
 */
 ...
 *  @param[in,out]  buffer                              Pointer to ACI message
 * buffer
 *  @param[in]      p_aci_cmd_params_open_remote_pipe   Pointer to the dynamic
 * data parameters in ::aci_cmd_params_open_remote_pipe_t
 *
 *  @return         None
 */
 ...
 *  @param[in,out]  buffer                              Pointer to ACI message
 * buffer
 *  @param[in]      p_aci_cmd_params_close_remote_pipe   Pointer to the dynamic
 * data parameters in ::aci_cmd_params_close_remote_pipe_t
 *
 *  @return         None
 */
 ...
 *
 *  @param[in,out]  buffer             Pointer to ACI message buffer
 *  @param[in]      p_cmd_params_echo  Pointer to the dynamic data parameters in
 ...
 *
 *  @param[in,out]  buffer  Pointer to ACI message buffer
 *  @param[in]      p_aci_cmd_params_change_timing  Pointer to the change timing
 * parameters in ::aci_cmd_params_change_timing_t
 *
 *  @return         None
 */
...
/** @brief Encode the ACI message to change timing request using the timing
 * parameters from GAP PPCP
 *
 *  @param[in,out]  buffer  Pointer to ACI message buffer
 *  @param[in]      p_aci_cmd_params_change_timing  Pointer to the change timing
 * parameters in ::aci_cmd_params_change_timing_t
 ...
 *  @param[in,out]  buffer                          Pointer to ACI message
 * buffer
 *  @param[in]      seq_no                          Sequence number of the
 * dynamic data (as received in the response to @c Read Dynamic Data)
 ...
 *
 *  @param[in,out]  buffer  Pointer to ACI message buffer
 *  @param[in]      p_aci_cmd_params_set_app_latency  Pointer to the
 * set_application_latency command parameters in ::aci_cmd_params_dtm_cmd_t
 *
 *  @return         None
 */
 ...
 *  @param[in,out]  buffer                          Pointer to ACI message
 * buffer
 *  @param[in]      p_cmd_params_set_run_behaviour  Pointer to the setup data in
 ...
 *  @param[in,out]  buffer                          Pointer to ACI message
 * buffer
 *  @param[in]      p_cmd_params_set_run_behaviour  Pointer to the DTM command
 * parameters in ::aci_cmd_params_dtm_cmd_t
 *
 *  @return         None
 */
 ...
 *  @param[in,out]  buffer     Pointer to the decoded message in
 ...
 *
 *  @param[in]      buffer_in  Pointer to message received
 *  @param[in,out]  p_aci_evt_params_pipe_status  Pointer to the decoded message
 * in ::aci_evt_params_pipe_status_t
 *
 *  @return         None
 */
 ...
 *
 *  @param[in]      buffer_in                      Pointer to message received
 *  @param[in,out]  p_aci_evt_params_disconnected  Pointer to the decoded
 * message in ::aci_evt_params_disconnected_t
 *
 *  @return         None
 */
 ...
 *
 *  @param[in]      buffer_in                     Pointer to message received
 *  @param[in,out]  p_aci_evt_params_bond_status  Pointer to the decoded message
 * in ::aci_evt_params_bond_status_t
 *
 *  @return         None
 */
 ...
 *
 *  @param[in]      buffer_in                   Pointer to message received
 *  @param[in,out]  p_evt_params_data_received  Pointer to the decoded message
 * in ::aci_evt_params_data_received_t
 *
 ...
 *
 *  @param[in]      buffer_in               Pointer to message received
 *  @param[in,out]  p_evt_params_data_ack   Pointer to the decoded message in
 ...
 *
 *  @param[in]      buffer_in                  Pointer to message received
 *  @param[in,out]  p_aci_evt_params_hw_error  Pointer to the decoded message in
 ...
 *
 *  @param[in]      buffer_in                 Pointer to message received
 *  @param[in,out]  p_evt_params_data_credit  Pointer to the decoded message in
 * ::aci_evt_params_data_credit_t
 *
 *  @return         None
 */
void acil_decode_evt_credit(
    uint8_t *buffer_in, aci_evt_params_data_credit_t *p_evt_params_data_credit);

/** @brief Decode the ACI event for connected
 *
 *  @param[in]      buffer_in                   Pointer to message received
 *  @param[in,out]  p_aci_evt_params_connected  Pointer to the decoded message
 * in ::aci_evt_params_connected_t
 *
 *  @return         None
 */
void acil_decode_evt_connected(
    uint8_t *buffer_in, aci_evt_params_connected_t *p_aci_evt_params_connected);

/** @brief Decode the ACI event for timing
 *
 *  @param[in]      buffer_in             Pointer to message received
 *  @param[in,out]  p_evt_params_timing   Pointer to the decoded message in
 ...
 *
 *  @param[in]      buffer_in                 Pointer to message received
 *  @param[in,out]  p_evt_params_pipe_error   Pointer to the decoded message in
 ...
 *
 *  @param[in]      buffer_in               Pointer to message received
 *  @param[in,out]  p_evt_params_key_type   Pointer to the decoded message in
 * ::aci_evt_params_key_type_t
 *
 *  @return         None
 */
void acil_decode_evt_key_request(
    uint8_t *buffer_in, aci_evt_params_key_request_t *p_evt_params_key_request);

/** @brief Decode the ACI event for echo
 *
 *  @param[in]      buffer_in    Pointer to message received
 *  @param[in,out]  buffer_out   Pointer to the echo message (max size of buffer
 * ::ACI_ECHO_DATA_MAX_LEN)
 *
