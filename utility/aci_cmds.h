 ...
 * @note Dynamic data chunk size in this command is defined to go up to
 * ACI_PACKET_MAX_LEN - 3
 */
typedef struct {
  uint8_t seq_no;
...
typedef struct {
  ...
  uint16_t adv_interval; /**< 16 bits of advertising interval for general
                            discovery */
