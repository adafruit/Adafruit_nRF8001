 ...
 *  @details
 *  This macro configures a given I/O to input or output with pullup/buffer
 * configuration.
 *  @param io_name I/O to configure.
 *  @param is_input Indicate if the I/O is to be set as an input.
 *  @param io_mode Pull resistor and buffer configuration (must be
 * HAL_IO_OUTPUT_NORMAL_STRENGTH, HAL_IO_OUTPUT_HIGH_STRENGTH,
 * HAL_IO_INPUT_BUF_ON_NO_PULL, HAL_IO_INPUT_BUF_ON_PULL_DOWN,
 * HAL_IO_INPUT_BUF_ON_PULL_UP, or HAL_IO_INPUT_BUF_OFF).
 */
