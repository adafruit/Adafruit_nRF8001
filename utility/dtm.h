...
/** @brief DTM command codes (upper two bits in the DTM command), use a bitwise
OR with the frequency N = 0x00 – 0x27: N = (F-2402)/2 Frequency Range 2402 MHz
to 2480 MHz*/
...
#define DTM_LE_PKT_0X0F                                                        \
  0x01 /**< Bit pattern 11110000 (LSB is the leftmost bit). */
#define DTM_LE_PKT_0X55                                                        \
  0x02 /**< Bit pattern 10101010 (LSB is the leftmost bit). */
#define DTM_LE_PKT_VENDOR                                                      \
  0x03 /**< Vendor specific. Nordic: continous carrier test */
